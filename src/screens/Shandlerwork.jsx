...
export default function Shandlerwork() {
  const navigate = useNavigate();
  const [flippedIndex, setFlippedIndex] = useState(null);

  const members = [
    {
      imgpj1: require('../assets/shandler1.png'), // Front image
      imgpj2: require('../assets/shandler1.png'), // Back image
    },
    {
      imgpj1: require('../assets/shandler2.png'), // Front image for second member
      imgpj2: require('../assets/shandler2.png'), // Back image for second member
    },
  ];
