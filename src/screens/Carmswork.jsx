...
export default function Carmswork() {
  const navigate = useNavigate();
  const [flippedIndex, setFlippedIndex] = useState(null);

  const members = [
    {
      imgpj1: require('../assets/caramel1.png'), // Front image
      imgpj2: require('../assets/caramel1.png'), // Back image
    },
    {
      imgpj1: require('../assets/caramel2.png'), // Front image for second member
      imgpj2: require('../assets/caramel2.png'), // Back image for second member
    },
  ];
                ...
                <div className="flip-card-inner1">
                  <div className="flip-card-front1">
                    <div className="member-photo-wrapper1">
                      <img src={member.imgpj1} alt="Member Front" className="member-photo4" />
                    </div>
                  </div>

                  <div className="flip-card-back1">
                    <img src={member.imgpj2} alt="Member Back" className="member-photo4" />
                  </div>
                </div>
              </div>
            ))}
